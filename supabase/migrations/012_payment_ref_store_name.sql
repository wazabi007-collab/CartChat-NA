-- Migration 012: Payment reference uses store name prefix instead of OSHI-
-- Also accepts optional pre-generated payment reference from client
...
BEGIN
  ...
  -- Generate payment reference: use client-provided ref or generate from store name
  IF p_payment_ref IS NOT NULL AND p_payment_ref <> '' THEN
    v_payment_ref := p_payment_ref;
  ELSE
    -- Build prefix from store name: first 4 alpha chars, uppercase
