            ...
            <div className="shrink-0 text-right">
              ...
              {isOutOfStock || disabled ? (
                ...
                <Link
                  ...
                  className="mt-1 inline-block rounded-full px-3 py-1 text-xs font-medium text-white transition-colors"
                ...
                <button
                  ...
                  className="min-h-11 inline-flex items-center justify-center text-white text-xs font-medium px-3 py-1 rounded-full mt-1 transition-colors"
                  style={{ backgroundColor: theme.accent }}
                  onMouseEnter={(e) => {
