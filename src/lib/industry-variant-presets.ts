...
const ATTRIBUTE_ORDER: Record<IndustryArchetype, string[]> = {
  ...
  retail: ["fit", "gender", "network", "denomination", "colour", "color", "size", "weight", "pack size", "strength", "type", "life stage", "material", "model", "storage", "connectivity", "condition"],
...
const ARCHETYPE_PRESETS: Record<IndustryArchetype, VariantPreset[]> = {
  ...
  retail: [
    ...
    },
    {
      ...
      description: "For general goods sold by size, colour, or variant (toys, stationery, homeware, curios).",
      recommendedAttributes: ["Size", "Colour", "Variant", "Material"],
      optionTextExamples: [
        "Size: Small, Colour: Assorted, Variant: Standard",
        "Size: Medium, Colour: Assorted, Variant: Standard",
        "Size: Large, Colour: Assorted, Variant: Deluxe",
      ],
    },
    {
      id: "pet-supplies",
      label: "Pet supplies",
      description: "For pet food and accessories sold by weight, size, or life stage.",
      recommendedAttributes: ["Weight", "Size", "Type", "Life Stage"],
      optionTextExamples: [
        "Weight: 1kg, Type: Dry Food, Life Stage: Adult",
        "Weight: 5kg, Type: Dry Food, Life Stage: Adult",
        "Weight: 2kg, Type: Dry Food, Life Stage: Puppy",
      ],
    },
    {
      id: "health-product",
      label: "Pharmacy or health product",
      description: "For health and pharmacy items sold by pack size, strength, or type.",
      recommendedAttributes: ["Pack Size", "Strength", "Type", "Size"],
      optionTextExamples: [
        "Pack Size: 10s, Strength: 200mg, Type: Tablets",
        "Pack Size: 20s, Strength: 200mg, Type: Tablets",
        "Pack Size: 100ml, Strength: Standard, Type: Syrup",
      ],
    },
    {
      id: "airtime-voucher",
      label: "Airtime, data or tokens",
      description: "For airtime, data bundles, and prepaid electricity sold by network and denomination.",
      recommendedAttributes: ["Network", "Denomination", "Type"],
      optionTextExamples: [
        "Network: MTC, Denomination: N$10, Type: Airtime",
        "Network: MTC, Denomination: N$29, Type: Data",
        "Network: TN Mobile, Denomination: N$50, Type: Airtime",
      ],
    },
  ],
  beauty: [
...
const INDUSTRY_PRESET_IDS: Record<string, string[]> = {
  ...
  furniture: ["general-merch", "hardware-parts"],
  stationery: ["general-merch"],
  sports: ["general-merch"],
  toys: ["general-merch"],
  crafts: ["general-merch"],
  general_dealer: ["general-merch"],
  other: ["general-merch"],
  gas_water: ["general-merch"],
  salon: ["salon-service", "beauty-product"],
  cosmetics: ["beauty-product"],
  pharmacy: ["health-product"],
  pet: ["pet-supplies"],
